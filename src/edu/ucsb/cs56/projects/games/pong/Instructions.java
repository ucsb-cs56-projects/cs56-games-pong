...
public class Instructions{
    ...
    // Creates the Frame, names it, and sets size
    ...
    // Sets up the layout on the frame and puts on the Instructions
    //   and the "Back To Main Menu" button
    ...
    // The action when the button "Back To Main Menu" is pressed
    // It just makes the frame not visible, so it appears to be closed
    //   and does not need to create a new instance of Instructions for
    //   every time the user clicks how to play
